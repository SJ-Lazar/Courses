...
namespace MachineLearning
{
    public partial class Demo
    {
        ...
        public class ModelInput
        {
            ...
            [LoadColumn(3)]
            [ColumnName(@"ProductPurchased")]
            public float ProductPurchased { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("Demo.mlnet");
